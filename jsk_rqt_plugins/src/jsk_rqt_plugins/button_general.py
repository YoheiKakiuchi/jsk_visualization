...
class ServiceButtonGeneralWidget(QWidget):
    ...
    def __init__(self, button_type="push"):
        ...
        if rospy.has_param("~layout_param"):
            ...
            layout_yaml_file = rospy.get_param("~layout_yaml_file")
            self.loadLayoutYamlFile(layout_yaml_file)
            rospy.loginfo("setup Buttons from ~layout_yaml_file")
    ...
    def loadLayoutYamlFile(self, layout_yaml_file):
        ...
        if layout_yaml_file in 'package://':
            ...
            resolved_layout_yaml_file = layout_yaml_file
        # check file exists
